...
//        userService.createUserWithPosts("John Doe", post1, post2);
        // User 1
        Comment c1_1 = new Comment("Great post!");
        Comment c1_2 = new Comment("It Sucks");
        Post post1_1 = userService.createPost("Alice", "Journey to the West", "It is a detailed narrative of adventures and experiences.", c1_1, c1_2);
        //Post post1_1 = new Post(0, , , "Alice");
        ...
        // User 2
        Comment c2_1 = new Comment("Awesome!");
        Comment c2_2 = new Comment("Boring");
        Comment c2_3 = new Comment("I'm going to sleep");
        Post post2_1 = userService.createPost("Bob", "Space Exploration", "New frontiers in space travel and exploration.", c2_1, c2_2, c2_3);
        Comment c3_1 = new Comment("Fantasy!");
        Comment c3_2 = new Comment("I'm the big fan of Deep sea");
        Comment c3_3 = new Comment("Amazing");
        Post post2_2 = userService.createPost("Bob", "Deep Sea Mysteries","Exploring the uncharted depths of the ocean.", c3_1, c3_2, c3_3);
        userService.createUserWithPosts("Bob", post2_1 ,post2_2);
